...
#opt$expression <- "output/Arabidopsis_thaliana/FEATURECOUNTS/TAIR10.gene.rlog.tsv"
#opt$softPower <- 12
#opt$term2gene <- "input/Arabidopsis_thaliana/GENOME/TERM2GENE.tsv"
#opt$term2name <- "workflow/TERM2NAME.tsv"
#opt$output <- "output/Arabidopsis_thaliana/WGCNA"
#opt$background <- "output/Arabidopsis_thaliana/DEA/upregulated.DEGs.txt"
#opt$forceTOMCalc <- "True"
#opt$threads <- 50
#opt$temp <- 'temp/Arabidopsis_thaliana/WGCNA/'
